...
export const projects: Project[] = [
  {
    ...
    architecture: [
      ...
      'Time-to-value optimization: on first login, system auto-creates a demo Bucket, pre-loads 2–3 sample Sources, and surfaces a one-click "Generate Post" CTA — no configuration required to reach first content output. Default strategy template applied until the org customizes it.',
