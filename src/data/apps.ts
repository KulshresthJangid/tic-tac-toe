...
export const appServices: AppService[] = [
  {
    ...
    name: 'tic-tac-toe',
    description:
      'Reverse proxy entry point (:443). Routes /kaizex to Kaizex frontend, /api/v1/ to smart-server backend. All production traffic passes through this layer.',
    route: '/',
    status: 'ONLINE',
    version: '1.0.0',
  ...
  },
  {
    ...
    name: 'Kaizex',
    description:
      'Next.js frontend for the Kaizex Marketing OS, served at /kaizex. Onboarding, Bucket management, Source ingestion, Insights browser, Post editor, Scheduling calendar, Analytics, and AI provider config.',
    route: '/kaizex',
    externalUrl: '/kaizex',
    status: 'ONLINE',
    version: '2.2.0',
